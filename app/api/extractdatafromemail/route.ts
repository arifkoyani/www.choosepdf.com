...
const EXTRACT_DATA_FROM_EMAIL_URL = process.env.CHOOSE_PDF_EXTRACT_DATA_FROM_EMAIL_URL || process.env.NEXT_PUBLIC_CHOOSE_PDF_EXTRACT_DATA_FROM_EMAIL_URL || "https://api.pdf.co/v1/email/decode";
