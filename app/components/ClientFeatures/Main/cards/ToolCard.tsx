...
export default function ToolCard({
	...
	return (
		<div>
			<Link
				href={href}
				className="tool-card-hover block px-6 py-12 bg-white rounded-4xl border border-neutral-300 shadow-xs hover:border-orange-200 transition-all duration-200"
			>
