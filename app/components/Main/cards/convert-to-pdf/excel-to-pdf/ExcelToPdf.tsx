...
export default function ExcelToPdf() {
	return (
		<div className="mt-12 w-full max-w-6xl">
            ...
            <FileAxis3d   className="w-8 h-12 text-[#ff911d] mb-1"  strokeWidth={1} />
                <h1 className="text-2xl font-bold text-gray-900 mt-2">EXCEL to PDF</h1>
				<p className="text-gray-600 text-base">
					Convert EXCEL to PDF with the easiest PDF EXCEL to PDF service.
				</p>
			</div>
		</div>
	)
